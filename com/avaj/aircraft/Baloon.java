...
public class Baloon extends Aircraft implements Flyable {
    ...
    public void updateConditions() {
        ...
        if ("SUN".equalsIgnoreCase(weather)){
            ...
            System.out.println("Baloon#" + this.name + "(" + this.id+ "): OMG!! it's snowing! i can see santa from here.");
            this.coordinates.setHeight(this.coordinates.getHeight() - 15);
        } else if ("FOG".equalsIgnoreCase(weather)) {
            System.out.println("Baloon#" + this.name + "(" + this.id+ "): foggy! frog frog frog! hey is't not a song.");
